...
//        $this->middleware('auth');
    ...
    public function order(Request $request)
    {
        ...
        $validator = Validator::make($data, [
            'currency' => 'required|exists:ct_currencies,id',
    ...
    public function orderCancel(Request $request)
    {
        ...
        DB::statement("call CancelOrder(?, ?, @result);",
            [$order_id, $amount]);
        $cancelResult = DB::select('select @result as result');
