...
@section('script')
    ...
    <script>
        ...
        var socket = io('https://central-bkoffice.crypto-tower.com', {path: '/ctex_1.0.0'});
        ...
        var widgetConfig = {
            ...
            overrides: {
                ...
                'mainSeriesProperties.areaStyle.color2': '#10163A',
                'mainSeriesProperties.areaStyle.linecolor': '#117a8b',
                'mainSeriesProperties.areaStyle.linewidth': 1,
                //背景
                'paneProperties.background': '#10163A',
                //网格线
...
//            'timeScale.rightOffent': 2,
            ...
            toolbar_bg: '#10163A',
            client_id : '{{ config('app.name', 'CENTRAL') }}',
